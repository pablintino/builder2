...
class CertificateManager:
    ...
    def __install_keystore_certificate(self, installation_summary: InstallationSummary, certificate: x509.Certificate,
                                       name: str = None):
        ...
        with tempfile.NamedTemporaryFile(mode='wb') as tmp:
            ...
            tmp.flush()
            self._command_runner.run_process([installation_summary.wellknown_paths[EXEC_NAME_JAVA_KEYTOOL],
                                              '-importcert',
                                              '-noprompt',
                                              '-storepass',
    ...
    def __install_jdk_certificates(self, installation_summary: InstallationSummary, certs: list[x509.Certificate]):
    ...
    def install_all_certificates(self, installation_summary: InstallationSummary, certs_path: str):
